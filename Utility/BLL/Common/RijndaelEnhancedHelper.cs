...
namespace ZaHra.Utility.BLL.Common
{
    public class RijndaelEnhancedHelper
    {
        ...
        /// </remarks>
        public RijndaelEnhancedHelper(string passPhrase) :
        ...
        /// in secret.
        /// </param>
        public RijndaelEnhancedHelper(string passPhrase,string initVector) :
        ...
        private byte[] GenerateSalt()
        {
            ...
            var saltLen = _minSaltLen == _maxSaltLen ? _minSaltLen : GenerateRandomNumber(_minSaltLen, _maxSaltLen);
